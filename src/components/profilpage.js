...
import Image from "next/image"; // Pastikan untuk mengimpor Image dari next/image
        ...
        >
          <div className="flex z-10 flex-col items-left mt-10 font-bold text-center h-full max-md:mt-5 max-md:max-w-full">
            <div className="flex items-center justify-center">
              <Image
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/ed0fd4ec77508fc16c44a49a926a47a314f0eead3b5aabca5394c5f943d26af8?apiKey=56720a43f79840e1abfb6fc8af490491&width=100" // Path gambar yang benar
                alt="Banner Image"
                width={100}
                height={100}
                className="max-w-full aspect-[0.93]" // Mengubah ukuran gambar agar lebih kecil
              />
